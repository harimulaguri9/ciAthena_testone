...
class ExcelWriter:
    def __init__(self, file_path):
        ...
        self.sheet.cell(row=1, column=12, value="raw_sql_comparision_result")
        self.sheet.cell(row=1, column=13, value="share_icon")
        self.sheet.cell(row=1, column=14, value="save_icon")
        self.sheet.cell(row=1, column=15, value="view_fullscreen_icon")
        self.sheet.cell(row=1, column=16, value="data_view_icon")
        self.sheet.cell(row=1, column=17, value="download_icon")
        self.sheet.cell(row=1, column=18, value="STATUS")


    def write_row(self, question, answer, sql_query, sql_icon,expected_sql_query, sql_query_match,
                  similarity_score, chart_icon, actual_chart, expected_chart_name,chat_match,raw_sql_comparision_result,
                  share_icon,save_icon,view_fullscreen_icon,data_view_icon, download_icon,status):
        self.row += 1
        ...
        self.sheet.cell(row=self.row, column=12, value=raw_sql_comparision_result)
        self.sheet.cell(row=self.row, column=13, value=share_icon)
        self.sheet.cell(row=self.row, column=14, value=save_icon)
        self.sheet.cell(row=self.row, column=15, value=view_fullscreen_icon)
        self.sheet.cell(row=self.row, column=16, value=data_view_icon)
        self.sheet.cell(row=self.row, column=17, value=download_icon)
        self.sheet.cell(row=self.row, column=18, value=status)
