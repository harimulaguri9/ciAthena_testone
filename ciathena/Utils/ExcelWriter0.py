...
class ExcelWriter0:
    def __init__(self, file_path):
        ...
        self.sheet.cell(row=1, column=7, value="Download_icon")
        self.sheet.cell(row=1, column=8, value="STATUS")


    def write_row(self, question, answer, sql_query, sql_icon,
                  share_icon,save_icon, download_icon,status):
        self.row += 1
        ...
        self.sheet.cell(row=self.row, column=7, value=download_icon)
        self.sheet.cell(row=self.row, column=8, value=status)
