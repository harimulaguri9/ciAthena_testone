...
INPUT_PATH = r"C:\HARI\ciATHENA_Backup\ciathena_autoamtion\LLM\FAST\FAST_Questions.xlsx"
OUTPUT_PATH = r"C:\HARI\ciATHENA_Backup\ciathena_autoamtion\LLM\FAST\FAST_Report.xlsx"
...
class ChatbotAutomation:
    def __init__(self, page: Page):
        ...
        self.page.locator("#welcome-app-name-insightsai").click()
    ...
    async def get_valid_response(self):
        if await self.valid_response_locator.is_visible(timeout=120000):
    ...
    async def get_actual_chart_name(self) -> str:
        try:
            ...
            await self.chart_button.wait_for(state="visible", timeout=20000)
